...
<body class="book-page">
	...
	<div class="container">
		<nav class="mainNav fourteen columns offset-by-one desktop-mobile-content">
			<ul class="navMenu">
		...
		<div class="content fourteen columns offset-by-one">
			...
			<ul class="navMenu secNav desktop-mobile-content">
			...
			<p class="desktop-mobile-content">Aenean rhoncus, elit sed ultrices tempor, nisl nisl rhoncus sapien, a luctus turpis ante sed urna.<br />
			...
			<ul class="navMenu bottomNav">
				<li><a href="#" class="teilen desktop-mobile-content">Teilen</a></li>
